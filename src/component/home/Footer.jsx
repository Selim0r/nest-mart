...
function Footer() {
  return (
    <footer className="bg-white text-gray-800 px-8 py-12 border-t border-gray-200">
     
      <div className="max-w-7xl mx-auto grid xl:grid-cols-6 lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-10">
